...
public class Experimento7 {
    ...
    public static void main(String[] args) {
        ...
        // Divide a lista de arquivos em 64 partes para serem processadas por cada thread (5 arquivos por thread)
        File[][] fileParts = new File[64][5];
        for (int i = 0; i < 64; i++) {
            System.arraycopy(listOfFiles, i * 5, fileParts[i], 0, 5);
        }
        ...
        // Cria 64 threads, cada uma processando uma parte dos arquivos
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("tempo_execucao_experimento7.txt"))) {
            writer.write("Tempo de execução com 64 threads (ms): " + executionTime);
            System.out.println("Tempo de execução salvo no arquivo: tempo_execucao_experimento7.txt");
        } catch (IOException e) {
