...
public class threads2 {
    ...
    public static void main(String[] args) {
        ...
        // Divide a lista de arquivos em duas partes para serem processadas por cada thread
        File[] firstHalfFiles = new File[160];
        File[] secondHalfFiles = new File[160];
        System.arraycopy(listOfFiles, 0, firstHalfFiles, 0, 160);
        System.arraycopy(listOfFiles, 160, secondHalfFiles, 0, 160);
        ...
        // Cria duas threads, cada uma processando uma parte dos arquivos
        Thread thread1 = new Thread(() -> {
            processFiles(firstHalfFiles, listaDeTemperaturas);
        });

        Thread thread2 = new Thread(() -> {
            processFiles(secondHalfFiles, listaDeTemperaturas);
        });
    ...
    // Método que processa os arquivos de uma parte específica (metade dos arquivos)
