...
public class Experimento8 {
    ...
    public static void main(String[] args) {
        ...
        // Divide a lista de arquivos em 80 partes para serem processadas por cada thread (4 arquivos por thread)
        File[][] fileParts = new File[80][4];
        for (int i = 0; i < 80; i++) {
            System.arraycopy(listOfFiles, i * 4, fileParts[i], 0, 4);
        }
        ...
        // Cria 80 threads, cada uma processando uma parte dos arquivos
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("tempo_execucao_experimento8.txt"))) {
            writer.write("Tempo de execução com 80 threads (ms): " + executionTime);
            System.out.println("Tempo de execução salvo no arquivo: tempo_execucao_experimento8.txt");
        } catch (IOException e) {
