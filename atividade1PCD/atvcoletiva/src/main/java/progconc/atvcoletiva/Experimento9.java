...
public class Experimento9 {
    ...
    public static void main(String[] args) {
        ...
        // Divide a lista de arquivos em 160 partes para serem processadas por cada thread (2 arquivos por thread)
        File[][] fileParts = new File[160][2];
        for (int i = 0; i < 160; i++) {
            System.arraycopy(listOfFiles, i * 2, fileParts[i], 0, 2);
        }
        ...
        // Cria 160 threads, cada uma processando uma parte dos arquivos
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("tempo_execucao_experimento9.txt"))) {
            writer.write("Tempo de execução com 160 threads (ms): " + executionTime);
            System.out.println("Tempo de execução salvo no arquivo: tempo_execucao_experimento9.txt");
        } catch (IOException e) {
